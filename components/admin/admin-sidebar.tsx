  ...
  return (
    <div className="flex h-full flex-col gap-2 border-r bg-muted/40">
      ...
      <div className="mt-auto p-4 border-t">
        <Link
          href="/dashboard"
          className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm text-muted-foreground transition-all duration-200 hover:bg-accent hover:text-accent-foreground active:scale-[0.98]"
        >
